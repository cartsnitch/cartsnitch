...
- **Store loyalty programs** — Kroger, Safeway (and more coming) — when you connect your account
- **Public manufacturer data** — packaging changes, suggested retail prices
- **USDA FoodData Central** — reference data for nutrition and package sizing
...
- **We don't collect receipts** (yet) — Store account connections give us enough data to track prices and compare baskets
